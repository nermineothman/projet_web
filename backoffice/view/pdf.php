<?php
  ...
  $pdoStat = $objectPdo->prepare('SELECT nom,description,prix,valable,image FROM produits ORDER BY nom ASC ');
...
<head>
  ...
  <title>Restaurent - Le surfin </title>
  ...
  <tbody>
          <?php foreach ($listeproduits as $listeproduits): ?> 
              <tr>
                ...
                <td><?PHP echo $listeproduits['valable']; ?></td>
                <td><?PHP echo $listeproduits['image']; ?></td>
